...
SET deploytargetbackupfolder=${deploy.backuprootfolder.dir}\${project.name}_${environment}_${websitename}_backup_%TIMESTAMP%
...
COPY "%DIR%..\environment.files\${environment}\web.config" "%dir.deploytarget%\web.config"
